  ...
  return (
    <div className="relative min-h-full" style={{ background: "#0a0a0a" }}>
      <div className="space-y-2 p-4 sm:p-6 lg:p-8">
        ...
        <p className="mb-4 text-sm italic" style={{ color: "#a3a3a3" }}>
        ...
        <div
          ...
          style={{ background: "#fffaf0", borderColor: "#262626", color: "#6b5849" }}
        >
          <span className="font-semibold" style={{ color: "#f5f5f5" }}>How this updates:</span>{" "}
