  ...
  if (!startDate || !endDate) {
    return (
      <div className="p-8">
        ...
        <p className="mt-6 rounded-xl border border-neutral-800 bg-neutral-900 p-8 text-center text-neutral-500">
      ...
      <div className="space-y-6 p-8">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <Link
              href={backHref}
              className="inline-flex items-center gap-2 text-sm text-neutral-500 hover:text-neutral-100"
            >
          ...
          {rangeLabel && (
            <span className="rounded-full border border-neutral-800 bg-neutral-900 px-4 py-2 text-sm font-medium text-neutral-300 shadow-sm">
              {rangeLabel}
            </span>
          )}
        </div>
