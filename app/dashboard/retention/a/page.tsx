import { CustomerRetention, PAPER } from "@/components/ui/customer-retention";
      ...
      <div className="p-8">
        <div className="mb-6">
          ...
          <p className="mt-2 text-sm italic" style={{ color: "#8a7763" }}>
            Weekly cohorts, followed forever. Pick a range to see who came back and who drifted away.
          </p>
        </div>
        <CustomerRetention />
      </div>
