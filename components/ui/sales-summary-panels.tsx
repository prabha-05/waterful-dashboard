...
function SplitBar({ split }: { split: BuyerSplit }) {
  ...
  if (split.total <= 0) {
    return <div className="h-1.5 w-full rounded-full bg-neutral-800" />;
  }
  return (
...
function MetricCard({
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-neutral-800 bg-neutral-900 p-5 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md">
    ...
    <div className="flex flex-col items-center gap-3">
      <div className="relative" style={{ width: size, height: size }}>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          <span className="text-base font-bold tabular-nums text-neutral-100">{totalFormatter(total)}</span>
        </div>
      </div>
...
function SplitDataTable({
  ...
  return (
    <div className="rounded-xl border border-neutral-800 bg-neutral-900 overflow-hidden">
      <div className="flex items-center justify-between gap-3 border-b border-neutral-800 bg-neutral-900/60 px-4 py-2.5">
        <p className="text-[11px] font-semibold uppercase tracking-wider text-neutral-500">
          {title} — table
        </p>
        <button
          onClick={downloadCsv}
          className="inline-flex items-center gap-1.5 rounded-lg border border-neutral-800 bg-neutral-900 px-3 py-1.5 text-xs font-semibold text-neutral-300 transition-colors hover:bg-neutral-900"
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm">
            ...
            {rows.map((r) => {
              ...
              return (
                <tr key={r.name} className="border-t border-neutral-800">
                  ...
                  <td className="px-3 py-2.5 text-right tabular-nums font-medium text-neutral-100">{total.toLocaleString()}</td>
          ...
          <tfoot>
            <tr className="border-t-2 border-neutral-800 bg-neutral-900/60">
              <td className="px-3 py-2.5 text-[10px] font-bold uppercase tracking-wider text-neutral-300">Total</td>
              <td className="px-3 py-2.5 text-right tabular-nums font-bold text-neutral-100">{grandTotal.toLocaleString()}</td>
        ...
        {data.map((d) => {
          ...
          return (
            <div key={d.name} className="flex items-center gap-3">
              ...
              <span className="w-10 shrink-0 text-right text-sm font-bold tabular-nums text-neutral-100">
    ...
    <div className="space-y-10">
      ...
      >
        {s.productSale.length === 0 ? (
          <p className="rounded-xl border border-dashed border-neutral-800 bg-neutral-900/40 p-6 text-center text-sm text-neutral-400">
          ...
          return (
            <div className="space-y-4">
              ...
              <div className="flex flex-col gap-4 md:flex-row md:items-stretch">
                ...
                <div className="flex items-center justify-center rounded-xl border border-neutral-800 bg-neutral-900 p-5 md:w-72">
                  <MultiSlicePie
                    slices={pieSlices}
                    total={pieTotal}
