      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            required
            className="w-full rounded-lg border border-white/10 bg-white/[0.05] px-4 py-2.5 text-sm
        ...
        <button
          type="submit"
          disabled={loading}
          className="mt-1 w-full rounded-lg bg-violet-600 px-4 py-2.5 text-sm font-medium
