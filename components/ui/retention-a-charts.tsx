...
export function RetentionAContent({
  ...
  function getCellColor(value: number) {
    ...
    return "bg-slate-900 text-neutral-300";
  }
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-slate-800">
                <th className="text-left py-3 px-3 font-semibold text-slate-300">Cohort</th>
                <th className="text-right py-3 px-3 font-semibold text-slate-300">Users</th>
                <th className="text-center py-3 px-2 font-semibold text-slate-300">M0</th>
                <th className="text-center py-3 px-2 font-semibold text-slate-300">M1</th>
                <th className="text-center py-3 px-2 font-semibold text-slate-300">M2</th>
                <th className="text-center py-3 px-2 font-semibold text-slate-300">M3</th>
                <th className="text-center py-3 px-2 font-semibold text-slate-300">M4</th>
                <th className="text-center py-3 px-2 font-semibold text-slate-300">M5</th>
                <th className="text-center py-3 px-2 font-semibold text-slate-300">M6</th>
              </tr>
            </thead>
            <tbody>
              {data.cohortTable.map((row) => (
                <tr key={row.cohort} className="border-b border-slate-800">
                  <td className="py-2 px-3 font-medium text-white">{row.cohort}</td>
                  <td className="py-2 px-3 text-right text-slate-300">{row.customers}</td>
