  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <div className="inline-flex items-center gap-1.5 rounded-xl border bg-slate-900 px-2 py-1" style={{ borderColor: BORDER }}>
      ...
      {error && (
        <div className="rounded-2xl border p-5 text-sm" style={{ background: "#0f172a", borderColor: BORDER, color: ROSE }}>
...
function DailyTable({ rows }: { rows: Daily[] }) {
  return (
    <div className="rounded-2xl border p-4 shadow-sm overflow-x-auto" style={{ background: "#0f172a", borderColor: BORDER }}>
      <div className="flex items-center justify-between mb-3">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-md border px-2.5 py-1 text-[11px] font-semibold transition-colors disabled:opacity-40 hover:bg-orange-950/30"
...
function UploadCard({ onUploaded }: { onUploaded: () => void }) {
  ...
  return (
    <div
      className="rounded-2xl border-2 border-dashed p-5 transition-colors hover:bg-orange-950/30"
      style={{ background: "#0f172a", borderColor: BORDER }}
