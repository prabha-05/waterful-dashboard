...
function StatRow({ label, value, color }: { label: string; value: string; color: string }) {
  return (
    <div className="flex items-center justify-between rounded-xl border p-4" style={{ borderColor: "#1e293b" }}>
...
function RetentionFunnel({ total, repeat, dropOff }: { total: number; repeat: number; dropOff: number }) {
  ...
  return (
    <div className="rounded-2xl border p-5 shadow-sm" style={{ background: "#0f172a", borderColor: "#1e293b" }}>
      <p className="mb-4 text-[11px] font-semibold uppercase tracking-wider" style={{ color: "#94a3b8" }}>
        Retention Funnel
      </p>
      <div className="space-y-3">
        ...
        <div>
          ...
          <div className="h-8 overflow-hidden rounded-lg" style={{ background: "#1e293b" }}>
      ...
      <p className="mt-4 text-[11px] italic" style={{ color: "#94a3b8" }}>
