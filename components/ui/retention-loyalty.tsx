...
function StatRow({ label, value, color }: { label: string; value: string; color: string }) {
  return (
    <div className="flex items-center justify-between rounded-xl border p-4" style={{ borderColor: "#262626" }}>
      <span className="text-sm" style={{ color: "#a3a3a3" }}>{label}</span>
...
function RetentionFunnel({ total, repeat, dropOff }: { total: number; repeat: number; dropOff: number }) {
  ...
  return (
    <div className="rounded-2xl border p-5 shadow-sm" style={{ background: "#171717", borderColor: "#262626" }}>
      <p className="mb-4 text-[11px] font-semibold uppercase tracking-wider" style={{ color: "#a3a3a3" }}>
        Retention Funnel
      </p>
