...
function StatRow({ label, value, color }: { label: string; value: string; color: string }) {
  return (
    <div className="flex items-center justify-between rounded-xl border p-4" style={{ borderColor: "#314158" }}>
      <span className="text-sm" style={{ color: "#90a1b9" }}>{label}</span>
...
function RetentionFunnel({ total, repeat, dropOff }: { total: number; repeat: number; dropOff: number }) {
  ...
  return (
    <div className="rounded-2xl border p-5 shadow-sm" style={{ background: "#1d293d", borderColor: "#314158" }}>
      <p className="mb-4 text-[11px] font-semibold uppercase tracking-wider" style={{ color: "#90a1b9" }}>
        Retention Funnel
      </p>
      ...
      <p className="mt-4 text-[11px] italic" style={{ color: "#90a1b9" }}>
