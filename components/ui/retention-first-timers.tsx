...
function GaugeBar({ label, pct, color }: { label: string; pct: number; color: string }) {
  return (
    <div className="space-y-1">
      ...
      <div className="h-2 w-full overflow-hidden rounded-full" style={{ background: "#1e293b" }}>
        <div
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    {PRESETS.map((p) => (
                      <button
                        ...
                        className="rounded-lg border px-3 py-1.5 text-xs font-medium transition-colors hover:bg-orange-950/30"
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
            ...
            <InsightCard title="What This Means">
              <div className="space-y-3">
                ...
                <div className="rounded-xl border p-3" style={{ borderColor: "#1e293b" }}>
