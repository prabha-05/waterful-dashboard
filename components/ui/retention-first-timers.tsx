...
function KpiCard({
  ...
  return (
    ...
    >
      ...
      {note && (
        <p className="mt-1.5 text-xs" style={{ color: "#90a1b9" }}>
          {note}
        </p>
      )}
    </div>
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    {PRESETS.map((p) => (
                      <button
                        ...
                        className="rounded-lg border px-3 py-1.5 text-xs font-medium transition-colors hover:bg-cyan-950/30"
                        style={{ borderColor: "#314158", color: INK }}
                      >
                        {p.label}
                      </button>
                    ))}
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
            ...
            <InsightCard title="What This Means">
              <div className="space-y-3">
                {ftPctOfCustomers > 80 ? (
                  <div className="flex items-start gap-3 rounded-xl p-3" style={{ background: "#fef5f0" }}>
                    ...
                    <div>
                      ...
                      <p className="mt-0.5 text-xs" style={{ color: "#90a1b9" }}>
                ...
                <div className="rounded-xl border p-3" style={{ borderColor: "#314158" }}>
