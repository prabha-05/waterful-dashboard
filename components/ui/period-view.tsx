            ...
            <div className="absolute z-50 mt-2 bg-[#0a0a0a] border border-neutral-800 rounded-xl shadow-lg p-3">
              ...
              <div className="flex justify-end gap-2 px-3 pb-2">
                <button
                  ...
                  className="px-3 py-1.5 text-sm text-neutral-400 hover:bg-[#0a0a0a] rounded"
                >
                  Cancel
                </button>
                <button
        ...
        <div className="flex gap-2">
          {PRESETS.map((p) => (
            <button
              ...
              className="px-3 py-2 text-sm text-neutral-400 hover:bg-neutral-900 rounded-lg border border-neutral-800 bg-[#0a0a0a]"
            >
              {p.label}
            </button>
          ))}
