...
function SplitBar({ split }: { split: BuyerSplit }) {
  ...
  if (split.total <= 0) return <div className="h-1.5 w-full rounded-full bg-neutral-900" />;
  return (
          ...
          {codes.map((c, i) => {
            ...
            return (
              <div key={c.code} className="space-y-1">
                ...
                <div className="flex h-2 w-full overflow-hidden rounded-full bg-neutral-900" style={{ width: `${widthPct}%` }}>
