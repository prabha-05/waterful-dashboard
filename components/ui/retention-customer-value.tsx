...
function FormulaCard({
  ...
  return (
    <div className="rounded-2xl border p-6 shadow-sm" style={{ background: "#0a0a0a", borderColor: "#1a1a1a" }}>
      <div className="flex items-center gap-3 mb-4">
        ...
        <p className="text-[11px] font-semibold uppercase tracking-wider" style={{ color: "#9ca3af" }}>{title}</p>
      </div>
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
            <div className="rounded-2xl border p-5 shadow-sm" style={{ background: "#0a0a0a", borderColor: "#1a1a1a" }}>
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <p className="text-[11px] font-semibold uppercase tracking-wider" style={{ color: "#9ca3af" }}>Drop-Off Rate</p>
            ...
            <div className="rounded-2xl border p-5 shadow-sm" style={{ background: "#0a0a0a", borderColor: "#1a1a1a" }}>
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <p className="text-[11px] font-semibold uppercase tracking-wider" style={{ color: "#9ca3af" }}>The Takeaway</p>
