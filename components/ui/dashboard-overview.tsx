  ...
  if (previous <= 0) {
    ...
    return (
      <span
        ...
        style={{ background: "#f5efe3", color: "#a3a3a3" }}
        title={tip}
      >
        new
      </span>
...
function HealthCard({
  ...
  return (
    ...
    >
      ...
      {value > 0 && (
        <>
          <div className="relative mt-3 flex h-1.5 w-full overflow-hidden rounded-full bg-neutral-800">
          ...
          <div className="relative mt-2 flex items-center justify-between text-xs">
            <span className="flex items-center gap-1 tabular-nums">
              ...
              <span style={{ color: "#a3a3a3" }}>new</span>
            </span>
            <span className="flex items-center gap-1 tabular-nums">
              <span style={{ color: "#a3a3a3" }}>repeat</span>
    ...
    <div className="w-64 p-2">
      <div className="mb-2 flex items-center justify-between">
        ...
        <button
          ...
          className="rounded-lg p-1.5 transition-colors hover:bg-neutral-800 disabled:cursor-not-allowed disabled:opacity-30"
          style={{ color: INK }}
            ...
            <button
              ...
              style={
                isSelected
                  ...
                  : { color: INK, background: isFuture ? "transparent" : "#171717" }
              }
              onMouseEnter={(e) => {
                if (!isSelected && !isFuture) e.currentTarget.style.background = `${AMBER}22`;
              }}
              onMouseLeave={(e) => {
                if (!isSelected && !isFuture) e.currentTarget.style.background = "#171717";
              }}
            >
              {m}
            </button>
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-4">
        <div
          ...
          style={{ borderColor: "#262626", background: "#171717" }}
        >
          <button onClick={dec} className="px-3 py-2.5 transition-colors hover:bg-neutral-900" style={{ color: INK }}>
            <Minus size={16} />
          </button>
          <input
            type="text"
            ...
            style={{ color: INK, borderColor: "#262626" }}
          />
          <button onClick={inc} className="px-3 py-2.5 transition-colors hover:bg-neutral-900" style={{ color: INK }}>
            <Plus size={16} />
          </button>
        </div>
        ...
        {unit === "month" ? (
          ...
          <div className="inline-flex items-center gap-2">
            ...
            <label className="text-[11px] font-semibold uppercase tracking-wider" style={{ color: "#a3a3a3" }}>
              Date
            </label>
            <input
              type="date"
              ...
              style={{ borderColor: "#262626", color: INK, background: "#171717" }}
            />
          </div>
        )}
      ...
      {data && splits && (
        <div
          ...
          style={{ background: "#171717", borderColor: "#262626" }}
        >
          <span className="text-[11px] font-semibold uppercase tracking-wider" style={{ color: "#a3a3a3" }}>
            Line guide
          </span>
          ...
          <span className="ml-auto text-xs italic" style={{ color: "#a3a3a3" }}>
      ...
      {!loading && data && splits && (
        <>
          ...
          <div className="-mx-4 px-4 sm:mx-0 sm:px-0 overflow-x-auto">
            <div className="inline-flex rounded-xl border overflow-hidden whitespace-nowrap" style={{ borderColor: "#262626" }}>
                ...
                {topPaymentMethods.length > 0 && (
                  ...
                  >
                    <div
                      ...
                      style={{ borderColor: "#f1e7d3", background: "#171717" }}
                    >
                      <h3 className="text-sm font-bold" style={{ color: INK }}>Payment Method — Period Breakdown</h3>
                      <p className="text-[11px] italic mt-0.5" style={{ color: "#a3a3a3" }}>
                      ...
                      <table className="w-full text-sm">
                        <thead>
                          <tr style={{ background: "#171717" }}>
                            <th className="px-3 py-2.5 text-left text-[10px] font-semibold uppercase tracking-wider whitespace-nowrap" style={{ color: "#a3a3a3" }}>Period</th>
                            ...
                            <th className="px-3 py-2.5 text-right text-[10px] font-semibold uppercase tracking-wider whitespace-nowrap" style={{ color: "#a3a3a3" }}>Total</th>
                          </tr>
                        </thead>
                        <tbody>
                        ...
                        <tfoot>
                          <tr className="border-t-2" style={{ borderColor: "#262626", background: "#171717" }}>
                  ...
                  >
                    ...
                    <div className="flex flex-wrap items-baseline justify-between gap-3 border-b pb-3" style={{ borderColor: "#f1e7d3" }}>
                      ...
                      <div className="flex flex-wrap items-baseline gap-5">
                        <div>
                          <span className="text-[10px] font-semibold uppercase tracking-wider" style={{ color: "#a3a3a3" }}>Total qty</span>
                          <span className="ml-2 text-xl font-bold tabular-nums" style={{ color: AMBER }}>{pb.totals.qty.toLocaleString()}</span>
                        </div>
                        <div>
                          <span className="text-[10px] font-semibold uppercase tracking-wider" style={{ color: "#a3a3a3" }}>Repeat %</span>
                    ...
                    <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                      ...
                      <div className="rounded-xl border p-4" style={{ borderColor: "#f1e7d3" }}>
                        <div className="mb-2 flex items-baseline justify-between gap-2">
                          <p className="text-[11px] font-semibold uppercase tracking-wider" style={{ color: "#a3a3a3" }}>
                            Sales
                          </p>
                        ...
                        <ResponsiveContainer width="100%" height={240}>
                          <LineChart data={pb.series} margin={{ top: 8, right: 10, left: 0, bottom: 0 }}>
                            ...
                            <XAxis
                              dataKey="label"
                              tick={{ fill: "#f5f5f5", fontSize: 11, fontWeight: 500 }}
                        ...
                        <ResponsiveContainer width="100%" height={240}>
                          <LineChart data={pb.series} margin={{ top: 8, right: 10, left: 0, bottom: 0 }}>
                            ...
                            <Tooltip
                              ...
                              contentStyle={{ fontSize: 12, borderRadius: 8, border: "1px solid #262626" }}
                            />
                            <Line
                              type="monotone"
                              dataKey="repeatPct"
          ...
          >
            <ResponsiveContainer width="100%" height={360}>
              <LineChart data={chartData} margin={{ top: 10, right: 20, left: 0, bottom: 0 }}>
                ...
                <XAxis
                  dataKey="label"
                  tick={{ fill: "#f5f5f5", fontSize: 12, fontWeight: 500 }}
                  axisLine={{ stroke: "#262626" }}
                  tickLine={false}
                  interval="preserveStartEnd"
                  minTickGap={24}
            ...
            >
              <div className="flex flex-wrap items-start justify-between gap-3">
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <span className="text-xs" style={{ color: "#a3a3a3" }}>overall</span>
                </div>
              </div>
              <div className="mt-4">
                <ResponsiveContainer width="100%" height={360}>
