    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <div className="relative">
          <button
            ...
            style={{ background: "#171717", borderColor: "#e8dcc8", color: INK }}
          >
          ...
          {showPicker && (
            <div className="absolute z-50 mt-2 rounded-xl border bg-neutral-900 p-3 shadow-xl" style={{ borderColor: "#e8dcc8" }}>
              <DayPicker
                mode="range"
                selected={range}
                onSelect={setRange}
        ...
        <div className="flex flex-wrap gap-2">
          {PRESETS.map((p) => (
            <button
              ...
              className="rounded-lg border bg-neutral-900 px-3 py-2 text-sm transition-colors hover:border-rose-300 hover:bg-rose-950/30/50"
      ...
      {!loading && !frequency && (
        <div
          ...
          style={{ borderColor: "#d9c9b0", background: "#171717" }}
        >
      ...
      {!loading && frequency && frequency.totalCustomers === 0 && (
        <div
          ...
          style={{ borderColor: "#e8dcc8", background: "#171717", color: INK }}
        >
    ...
    >
      <div className="mb-4 flex items-start justify-between gap-4">
        ...
        <div className="text-right">
          <p className="text-[11px] uppercase tracking-wider" style={{ color: "#a3a3a3" }}>
        ...
        <table className="w-full border-collapse text-sm">
          ...
          <tbody>
            ...
            <tr style={{ background: "#f7efdf" }}>
              ...
              <td className="px-4 py-3 text-left text-[11px]" style={{ color: "#a3a3a3" }}>
      ...
      <p className="mt-3 text-xs italic" style={{ color: "#a3a3a3" }}>
