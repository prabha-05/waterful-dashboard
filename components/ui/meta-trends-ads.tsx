...
export function MetaTrendsAds() {
  ...
  if (loading) {
    return (
      <div className="rounded-2xl border p-12 text-center text-sm italic" style={{ background: "#0f172a", borderColor: BORDER, color: MUTED }}>
        Loading trends…
      </div>
    );
  }
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="flex flex-col gap-1.5">
          ...
          <select
            ...
            style={{ borderColor: BORDER, color: INK, background: "#0f172a" }}
          >
            {campaigns.map((c) => (
...
function MetricGuide() {
  ...
  return (
    <section className="rounded-2xl border p-5 shadow-sm" style={{ background: "#0f172a", borderColor: BORDER }}>
